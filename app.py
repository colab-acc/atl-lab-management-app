...
def atlcalendar():
    ...
    for record in data:
        ...
        dic[
            'description'] = f"{record[9]}<br><br><b>Incharge:</b> {record[3].title()}<br><b>Guest:</b> {record[6].title()}<br><b>Mode:</b> {record[4]}<br><b>Venue:</b> {record[5]}"
        dic['type'] = 'event'
...
def allotment():
    ...
    return render_template("allotment.html", data=data)
...
def calendar(mg=''):
    ...
    for record in data:
        ...
        dic['badge'] = f"{record[1]} - {record[2]}"
        dic['date'] = [f"{record[7]}",f"{record[8]}"]
        dic['description'] = f"{record[9]}<br><br><b>Incharge:</b> {record[3].title()}<br><b>Guest:</b> {record[6].title()}<br><b>Mode:</b> {record[4]}<br><b>Venue:</b> {record[5]}"
        dic['type'] = 'event'
...
# contents = ['Hey!',
#             f'Your Request for item: {item_name} has been approved by incharge: {issuer_name}',
#             f'You are informed to collect the item anytime between {startt}hrs and {endt}hrs, on school days.',
#             f'Venue: {loc}',
